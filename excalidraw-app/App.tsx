  ...
  useEffect(() => {
    ...
    const initializeScene =
      async (): Promise<ExcalidrawInitialDataState | null> => {
        ...
        if (roomLinkData && collabAPI) {
          const scene = await collabAPI.startCollaboration(roomLinkData);
          return {
            elements: scene.elements || [],
            appState: scene.appState || getDefaultAppState(),
          };
        }

        // Load local scene if no collaboration
        return importFromLocalStorage();
      };
